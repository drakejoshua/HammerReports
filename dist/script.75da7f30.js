...
var manager = new _hammerjs.default.Manager(box);

// create new custom tap recognizers( tap, doubletap, tripletap ) { using hammer.js code library }
var doubleTapRecognizer = new _hammerjs.default.Tap({
  event: "doubletap",
  taps: 2,
  interval: 300
}); // for doubletap

var tripleTapRecognizer = new _hammerjs.default.Tap({
  event: "tripletap",
  taps: 3,
  interval: 300
}); // for tripletap

var tapRecognizer = new _hammerjs.default.Tap({
  event: "tap",
  taps: 1
}); // for tap only

// create new custom swipe recognizers( swipe-up, swipe-down, swipe-left, swipe-right ) { using hammer.js code library }
var swipeUpRecognizer = new _hammerjs.default.Swipe({
  event: "swipeup",
  velocity: 0.3,
  direction: _hammerjs.default.DIRECTION_UP
}); // for swipe up

var swipeDownRecognizer = new _hammerjs.default.Swipe({
  event: "swipedown",
  velocity: 0.3,
  direction: _hammerjs.default.DIRECTION_DOWN
}); // for swipe down

var swipeLeftRecognizer = new _hammerjs.default.Swipe({
  event: "swipeleft",
  velocity: 0.3,
  direction: _hammerjs.default.DIRECTION_LEFT
}); // for swipe left

var swipeRightRecognizer = new _hammerjs.default.Swipe({
  event: "swiperight",
  velocity: 0.3,
  direction: _hammerjs.default.DIRECTION_RIGHT
}); // for swipe right

var panStartRecognizer = new _hammerjs.default.Pan({
  event: "panstart",
  threshold: 10,
...
manager.add([tripleTapRecognizer, doubleTapRecognizer, tapRecognizer, swipeUpRecognizer, swipeLeftRecognizer, swipeRightRecognizer, swipeDownRecognizer, panStartRecognizer]);
...
},{"./style.css":"style.css","hammerjs":"node_modules/hammerjs/hammer.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
